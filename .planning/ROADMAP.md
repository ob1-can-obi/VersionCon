...
- [ ] **Phase 7: Cloud Mode + Relay Server** - Relay deployment, JWT auth, CloudTransport, same UX as LAN over internet (Wave 1 complete: 07-01 ✓, 07-02 ✓, 07-03 ✓; Wave 2 complete: 07-04 ✓, 07-05 ✓, 07-06 ✓, 07-07 ✓; Wave 3 in progress: 07-08 ✓ relay skeleton, 07-09 ✓ relay auth, 07-10 ✓ relay limits + grace timer; 973 / 0 / 66 extension tests + 44 relay tests passing; ROADMAP SC-3 closed)
...
| 7. Cloud Mode + Relay Server | 10/13 | In Progress (Wave 1 ✓; Wave 2 ✓; Wave 3 — 07-08 ✓ skeleton, 07-09 ✓ auth, 07-10 ✓ limits; 07-11 next) | - |
