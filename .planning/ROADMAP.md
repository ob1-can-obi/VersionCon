...
- [ ] **Phase 7: Cloud Mode + Relay Server** - Relay deployment, JWT auth, CloudTransport, same UX as LAN over internet (Wave 1 complete: 07-01 ✓, 07-02 ✓, 07-03 ✓; Wave 2 complete: 07-04 ✓, 07-05 ✓, 07-06 ✓, 07-07 ✓; Wave 3 complete: 07-08 ✓ relay skeleton, 07-09 ✓ relay auth, 07-10 ✓ relay limits + grace timer, 07-11 ✓ relay logger; 973 / 0 / 66 extension tests + 63 relay tests passing; ROADMAP SC-3 closed; Wave 4 next: 07-05b host cloud wiring + 07-12 deployment docs)
...
| 7. Cloud Mode + Relay Server | 11/13 | In Progress (Wave 1 ✓; Wave 2 ✓; Wave 3 ✓ — 07-08 skeleton + 07-09 auth + 07-10 limits + 07-11 logger; Wave 4 next: 07-05b host cloud + 07-12 deploy/docs) | - |
