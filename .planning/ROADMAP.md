...
- [ ] **Phase 7: Cloud Mode + Relay Server** - Relay deployment, JWT auth, CloudTransport, same UX as LAN over internet (Wave 1 complete: 07-01 ✓, 07-02 ✓, 07-03 ✓; Wave 2 in progress: 07-04 ✓, 07-05 ✓; 933 / 0 / 66 tests passing)
...
| 7. Cloud Mode + Relay Server | 5/13 | In Progress (Wave 1 ✓; Wave 2 in progress — 07-04 ✓, 07-05 ✓) | - |
