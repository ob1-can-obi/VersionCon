...
- [ ] **Phase 7: Cloud Mode + Relay Server** - Relay deployment, JWT auth, CloudTransport, same UX as LAN over internet (Wave 1 complete: 07-01 ✓, 07-02 ✓, 07-03 ✓; Wave 2 complete: 07-04 ✓, 07-05 ✓, 07-06 ✓, 07-07 ✓; Wave 3 complete: 07-08 ✓ relay skeleton, 07-09 ✓ relay auth, 07-10 ✓ relay limits + grace timer, 07-11 ✓ relay logger; Wave 4 host wiring DONE: 07-05b ✓ SessionHostFactory.createCloud + CloudHostTransport demultiplexer + envelope.target unicast + relay first-frame carve-out + per-joiner JWT; 996 / 0 / 66 extension tests + 71 relay tests passing; ROADMAP SC-3 closed; SC-1 + SC-2 paper-verifiable; last plan: 07-12 deployment docs)
...
| 7. Cloud Mode + Relay Server | 12/13 | In Progress (Wave 1 ✓; Wave 2 ✓; Wave 3 ✓; Wave 4 host wiring ✓ — 07-05b SessionHostFactory + CloudHostTransport demux + envelope.target unicast + relay first-frame carve-out + per-joiner JWT; last plan: 07-12 deploy/docs) | - |
